...
import { storesPageHtml, initStoresPage } from './stores.js?v=19';
import { usersPageHtml, initUsersPage } from './users.js?v=19';
import { inventoryPageHtml, initInventoryPage } from './inventory.js?v=19';
import { procurementPageHtml, initProcurementPage } from './procurement.js';
import { productsPageHtml, initProductsPage } from './products.js?v=19';
import { suppliersPageHtml, initSuppliersPage } from './suppliers.js?v=19';
import { storeItemsPageHtml, initStoreItemsPage } from './store_items.js?v=19';
...
import { productAnalysisPageHtml, initProductAnalysisPage } from './product_analysis.js?v=19';
