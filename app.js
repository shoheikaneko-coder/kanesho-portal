...
// 各ページのインポート
import { dashboardPageHtml, initDashboardPage } from './dashboard.js?v=90';
import { attendancePageHtml, initAttendancePage } from './attendance.js?v=90';
import { salesPageHtml, initSalesPage } from './sales.js?v=90';
