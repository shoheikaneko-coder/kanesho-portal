...
// 各ページのインポート
import { dashboardPageHtml, initDashboardPage } from './dashboard.js?v=80';
import { attendancePageHtml, initAttendancePage } from './attendance.js?v=80';
import { salesPageHtml, initSalesPage } from './sales.js?v=80';
