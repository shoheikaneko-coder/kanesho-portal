...
import { storesPageHtml, initStoresPage } from './stores.js?v=21';
import { usersPageHtml, initUsersPage } from './users.js?v=21';
import { inventoryPageHtml, initInventoryPage } from './inventory.js?v=21';
import { procurementPageHtml, initProcurementPage } from './procurement.js';
import { productsPageHtml, initProductsPage } from './products.js?v=21';
import { suppliersPageHtml, initSuppliersPage } from './suppliers.js?v=21';
import { storeItemsPageHtml, initStoreItemsPage } from './store_items.js?v=21';
...
import { productAnalysisPageHtml, initProductAnalysisPage } from './product_analysis.js?v=21';
